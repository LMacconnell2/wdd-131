...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    const creditCardInput = document.querySelector("#cardi")
    const paypalContainer = document.querySelector("#paypal-name");
    const paypalInput = document.querySelector("#paypali")
    ...
    else if (formValue == "debit") {
      creditCardContainer.classList.remove("hide");
      creditCardInput.required = true;
      paypalContainer.classList.remove("hide");
      paypalInput.required = true;
    }
    else if (formValue == "paypal") {
  ...
  const theForm = document.querySelector("#payment-method");
  togglePaymentDetails()
  theForm.addEventListener('change', togglePaymentDetails);
