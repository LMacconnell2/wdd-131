...
console.log("Sorted with compareFn:", anotherSort);

// // Default sorting (case-sensitive)
const simpleSort = [...simpleList].sort();
console.log("Default sort:", simpleSort);

const hikeSort = [...hikes].sort(compareFunction);
console.log("Sorted the Objects:", hikeSort);
...
console.log("Search", searchList(hikes, "ch").sort(compareFn));
